...
const apartment = getApartmentBySlug('erholungs-kellerchen')!;

export const metadata: Metadata = {
  title: 'Erholungs Kellerchen | Günstige Ferienwohnung Bad Lippspringe',
  description:
    'Gemütliche Souterrain-Ferienwohnung in Bad Lippspringe nahe der Westfalen Therme. ' +
    'Ca. 25 qm, Doppelbett, Küche, Bad. Ab 40 Euro/Nacht. Ideal für Paare & Alleinreisende.',
  keywords: [
    'Erholungs Kellerchen',
    'Ferienwohnung Bad Lippspringe',
    'günstige Unterkunft Bad Lippspringe',
    'Souterrain Wohnung',
    'Westfalen Therme Unterkunft',
    'Kurort Ferienwohnung',
  ],
  openGraph: {
    title: 'Erholungs Kellerchen | Günstige Ferienwohnung Bad Lippspringe',
    description:
      'Gemütliche Souterrain-Ferienwohnung in Bad Lippspringe nahe der Westfalen Therme. Ab 40 Euro/Nacht.',
    type: 'website',
    locale: 'de_DE',
            ...
            <section aria-labelledby="location-heading">
              ...
              <div className="w-full overflow-hidden rounded-xl border border-border-light shadow-sm aspect-video sm:aspect-auto">
                <iframe
                  ...
                  title="Standort Erholungs Kellerchen - Adolf-Kolping-Str. 11, 33175 Bad Lippspringe"
