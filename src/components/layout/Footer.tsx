      ...
      <div className="max-w-7xl mx-auto px-6 pt-16 pb-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 lg:gap-8">
          ...
          <div className="lg:col-span-1">
            ...
            <address className="not-italic text-sm text-white/60 leading-relaxed">
              <span className="flex items-start gap-2">
                <MapPin size={14} className="mt-1 shrink-0 text-accent/70" />
                <span>
          ...
          <div>
            ...
            <ul className="space-y-4">
              <li>
                <a
                  ...
                  className="flex items-center gap-3 text-sm text-white/70 hover:text-white transition-colors duration-[var(--transition-fast)]"
                >
                  <Phone size={16} className="shrink-0 text-accent/70" />
                  0177 1666353
                </a>
              </li>
              <li>
                <a
                  ...
                  className="flex items-center gap-3 text-sm text-white/70 hover:text-white transition-colors duration-[var(--transition-fast)]"
                >
                  <Mail size={16} className="shrink-0 text-accent/70" />
                  info@erholungs-apartments.de
                </a>
              </li>
              <li>
                <div className="flex items-start gap-3 text-sm text-white/70">
                  <MapPin size={16} className="shrink-0 mt-0.5 text-accent/70" />
                  <span>
                    Adolf-Kolping-Str. 11
                    <br />
                    33175 Bad Lippspringe
            ...
            {/* Google Maps Embed */}
            <div className="mt-6 rounded-xl overflow-hidden border border-white/10 aspect-video">
              <iframe
            ...
            <div className="flex items-center gap-6">
              {LEGAL_LINKS.map((link) => (
                <Link
                  key={link.href}
                  href={link.href}
                  className="hover:text-white/80 transition-colors duration-[var(--transition-fast)]"
                >
                  {link.label}
                </Link>
              ))}
